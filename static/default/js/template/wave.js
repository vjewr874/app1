...
(function () {
	...
	if("undefined" == typeof site_name_zh) site_name_zh = "";
	if("undefined" == typeof site_name_tw) site_name_tw = "";
	if("undefined" == typeof site_name_en) site_name_en = "";
    ...
    var w = {
        zh: {
            ...
            GO_OUT_WECHAT_TIP: "<span class=\"span1\">\n" +
                "            <img src=\"/static/images/click_btn.png\">\n" +
                "        </span>\n" +
                "        <span class=\"span2\">\n" +
                "            <em>1</em> 点击右上角\n" +
                "            <img src=\"/static/images/menu_android.png\">\n" +
                "            打开菜单\n" +
                "        </span>\n" +
			...
			USE_SAFARI_TIP: "<span class=\"span1\">\n" +
                "            <img src=\"/static/images/click_btn.png\">\n" +
                "        </span>\n" +
                "        <span class=\"span2\">\n" +
                "            <em>1</em> 返回桌面\n" +
        ...
        "zh-tw": {
            ...
            UNTRUSTED_ENTERPRISE_DEVELOPER: "<div style=\"text-align:center;padding:15px;\"><a target=\"_blank\" href=\"/guide.php\" style=\"color:#157df1;\"><span class=\"glyphicon glyphicon-hand-right\"></span>&nbsp;&nbsp;未受信任的企業開發者</a></div>",
            VERSION: "版本",
            SIZE: "大小",
            UPDATE_TIME: "更新時間",
            FOR_ANDROID: "適用于安卓手機",
    ...
    $(function () {
        window.DAFU = {
            ...
            successVip: function () {
                ...
                if (this.APP.show_guide && this.APP.ext == 'iOS') {
            ...
            showPopup: function () {
                ...
                var appType = (this.APP.ext == 'iOS') ? 'ios' : 'android';
                if (weixin == true) {
					$('.down_load').hide();
                    if (isiOS == true) {
                        $("#weixin_ios").show();
				...
				if(isiOS && !isSafari && (browser.versions.UCbrw || this.APP.fileExt=='mobileconfig')){
				    $('.down_load').hide();
					$("#no_safari").show();
				}
                ...
                if (appType == 'android' && isiOS) {
                    ...
                    $('.down_load').click(function () {
                        ...
                        if (c && d && "ios" == appType && app_source != 3) {
                            setTimeout(function () {
                                $("#showtext").hide();
                                var a = $("<a href='/static/app/embedded.mobileprovision' class='ms-btn template-btn clearfix pc-pwd' style='display:block;background-color:#40acf1; border: 1px solid #40acf1;margin: 15px'>" + w[language].TRUST_DEVELOPER + "</a>");
                                $("#showtext").after(a);
                            }, 6000);
                        }
                    });
            ...
            submitPwd: function () {
                ...
                $.getJSON('/source/index/ajax.php?ac=check-password', {url: url, password: password}, function (data) {
                    if (data.code == 200) {
                        window.location.href = '/' + url + '?t='+data.time+'&password=' + password;
                    } else {
