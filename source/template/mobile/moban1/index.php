...
<body class="index-page">
  <header id="header" class="header">
    <div class="module header-module">
      <div class="header-inner module-inner">
        <h1>
          <?php echo IN_NAME ?>
          <img src="/static/index/image/logo-top.png" alt="">
        </h1>
        <ul  class="menu">
          <li class="active"><a href="#" >首页</a></li>
          <?php if($this->userlogined){ ?>
          <li><a href="/index/apps/apps" >我的应用</a></li>
          <?php } ?>	 
          <li><a href="/index/price" >价格服务</a></li>
          <li><a href="/index/utils" >工具箱</a></li>
          <?php if($this->userlogined){ ?>
		  <li><a href="<?php echo IN_PATH.'index/user_profile' ?>">用户中心</a> </li>
          <?php }else{ ?>  
    ...
    <section class="swiper-module">
      <div class="swiper-container" id="bannerSwiper">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide super_sign-slide" style="z-index: 1;">
            <div class="slide-inner">
              <div class="content">
              ...
              <div class="top-banner-bg">
                <img src="/source/template/pc/moban1/img/super_sign-hd-bg.svg">
              </div>
  ...
  <div class="cmpy-info module">
    <div class="module-inner gift-inner">
      <p>注册领取多款免费福利</p>
      <div>
        <a class="btn small-btn empty-yellow-btn" href="/index/login">免费试用</a>
        <a class="btn small-btn yellow-btn" href="/index/reg">立即注册</a>
      </div>
    </div>
    <div class="module-inner cmpy-inner">
      ...
      <div class="info">
        <div>
          <p>产品概览</p>
          <ul>
            <li><a href="/index/publish/apps" title="">分发托管</a></li>
            <li><a href="/index/publish/apps" title="">企业签名</a></li>
            <li><a href="/index/price" title="">价格服务</a></li>
          </ul>
        </div>
        <div>
          <p>关于我们</p>
          <ul>
            <li><a href="/index/about" title="">公司介绍</a></li>
            <li><a href="/index/about/agreement" title="">服务协议</a></li>
            <li><a href="/index/about/specification" title="">审核规则</a></li>
          </ul>
        </div>
        <div class="about">
          <p>联系我们</p>
