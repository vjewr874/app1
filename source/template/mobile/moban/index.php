      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbar">
          <ul class="navbar-nav">
			...
			<li><a class="nav-link" href="<?php echo IN_PATH.'index/apps/apps' ?>">我的应用</a> </li>
			<?php } ?>						
            <li><a class="nav-link" href="/index/price">价格</a></li> 
            <li><a class="nav-link" href="/index/feedback">建议反馈</a></li> 
            <li><a class="nav-link" href="/index/about">关于我们</a></li> 
            <li><a class="nav-link" href="/index/utils">工具箱</a></li> 
            <?php if($this->userlogined){ ?>
			<li><a class="nav-link" href="<?php echo IN_PATH.'index/user_profile' ?>">用户中心</a> </li>
			<?php }else{ ?>             
            <li><a class="nav-link" href="/index/login">立即登陆</a></li>
            <li><a class="nav-link" href="/index/reg">免费注册</a></li>
			<?php } ?>	
          </ul>
        </div>
          ...
          <div class="col col-md-10 col-lg-7 col-xl-6 p-80px-tb md-p-30px-b">
            <div class="home-text-center theme-after m-50px-t md-m-20px-t">
              ...
              <div class="app-btn-set">
                <a href="/index/publish/apps" class="m-btn m-btn-white" data-text="Apply Now">立即上传</a>
              </div>
            </div> 
          </div> 
          ...
          <div class="row align-items-center justify-content-center">
            <div class="col-md-5 order-md-2 sm-m-30px-b">
              <div class="feature-box-04">
                ...
                <a href="/index/publish/apps" class="m-btn m-btn-theme">立即签名</a>
              </div>
            </div>
          ...
          <div class="col-md-6 col-lg-6">
            <div class="contact-form">
              ...
              ，只要一个ipa文件，5分钟快速在线签名APP应用
				<p></p>
				<a href="/index/reg" class="m-btn-theme m-btn">前往自助免费注册系统</a>
                          </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-6 col-md-3 col-lg-2 sm-m-15px-tb">
            ...
            <ul class="fot-link">
              <li><a href="/index/publish/apps">上传应用</a></li>
              <li><a href="/index/price">价格栏目</a></li>
          ...
          <div class="col-6 col-md-3 col-lg-2 sm-m-15px-tb">
            ...
            <li><a href="/index/about/privacy">隐私政策</a></li>
            <li><a href="/index/about/log">更新日志</a></li>        
              </ul>
          </div>
